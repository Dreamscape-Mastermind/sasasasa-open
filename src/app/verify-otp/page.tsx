  ...
  const handleResendOTP = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || 'Failed to resend verification code. Please try again shortly.')
      }
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center px-2 sm:px-4 py-4 sm:py-8">
      ...
      <div className="max-w-md w-full space-y-2">
        <div className="text-center">
          ...
          />
          <h2 className="mt-4 sm:mt-6 text-2xl sm:text-3xl font-bold">Please Confirm Your Email</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-200">
            Please enter the verification code sent to {email}. <small className="text-gray-400">OTP code is valid for 10 minutes.</small>
          </p>
        </div>
              ...
              <DialogDescription className="space-y-3 text-sm sm:text-base">
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="text-gray-700 dark:text-gray-300 ml-3">
                      Thank you for joining our waitlist and newsletter. Your early support means a lot to us!
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="text-gray-700 dark:text-gray-300 ml-3">
                      You'll be among the first to know about our new features and updates plus great offers and deals on your favourite events.
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="text-gray-700 dark:text-gray-300 ml-3">
                      Event offers and tickets will be dropping soon, check your email for updates from <a href="mailto:info@sasasasa.co" className="text-[#CC322D] hover:underline">info@sasasasa.co</a>
                    </div>
                  </div>
                </motion.div>
              </DialogDescription>
