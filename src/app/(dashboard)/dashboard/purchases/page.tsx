    ...
    >
      ...
      <p className="text-muted-foreground mb-6">
        {searchQuery || statusFilter !== "all"
          ...
          : "You haven't made any ticket purchases yet. Start exploring events to make your first purchase!"}
      </p>
      {(searchQuery || statusFilter !== "all") && (
        <Button
          variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <Card className="border-destructive">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                {error.message ||
                  "Something went wrong while loading your purchases."}
              </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <Input
                        placeholder="Search purchases by event name, ticket type, or ticket number..."
                        value={searchQuery}
