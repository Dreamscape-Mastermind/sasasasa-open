    ...
    <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row lg:items-center">
      ...
      <div className="flex flex-col justify-center sm:text-center lg:text-left xl:w-5/12">
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
          <a href="#" className="inline-block rounded-lg bg-[#CC322D] px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-[#CC322D]/90  focus-visible:ring active:bg-[#CC322D]/90  md:text-base">Publish</a>
