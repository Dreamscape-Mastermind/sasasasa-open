...
export function CheckInContent({ eventId }: { eventId: string }) {
  ...
  const getStatusColor = (status: CheckInStatus) => {
    switch (status) {
      case CheckInStatus.SUCCESS:
        return "bg-green-50 border-green-200 dark:bg-green-900/40 dark:border-green-700";
      case CheckInStatus.FAILED:
      case CheckInStatus.INVALID_QR:
      case CheckInStatus.WRONG_EVENT:
        return "bg-red-50 border-red-200 dark:bg-red-900/40 dark:border-red-700";
      case CheckInStatus.DUPLICATE:
        return "bg-yellow-50 border-yellow-200 dark:bg-yellow-900/40 dark:border-yellow-700";
      default:
  ...
  return (
    <div className="p-3 md:p-6 bg-gray-50 dark:bg-[#18181b]">
      {/* Header */}
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between mb-8">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:space-x-3">
          <button
            ...
            className="flex items-center px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 bg-white dark:bg-[#232326]"
          >
          ...
          <button
            ...
            className="flex items-center px-4 py-2 bg-[#CC322D] text-white rounded-lg hover:bg-gray-700 dark:hover:bg-red-700"
          >
      ...
      <div className="mt-8 bg-white dark:bg-[#232326] rounded-t-2xl md:rounded-lg shadow-sm">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center">
              <QrCode className="h-6 w-6 text-[#CC322D] dark:text-[#CC322D] mr-2" />
            ...
            <button
              ...
              className={`flex items-center px-6 py-3 rounded-lg font-medium transition-colors w-full sm:w-auto mt-2 sm:mt-0
                ${
                  isScannerActive
                    ? "bg-red-600 dark:bg-[#CC322D] text-white hover:bg-red-700 dark:hover:bg-red-700"
                    : "bg-[#CC322D] text-white hover:bg-red-700 dark:bg-[#CC322D] dark:hover:bg-red-700"
                }
              `}
            >
              {isScannerActive ? (
        ...
        <div className="p-6">
          ...
          {/* Processing State */}
          {isProcessing && (
            <div className="mb-6 p-6 bg-blue-50 dark:bg-blue-900 border-2 border-blue-200 dark:border-blue-700 rounded-lg">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <p className="font-mono text-sm bg-white dark:bg-[#18181b] p-2 rounded border dark:border-gray-700 mt-1 text-gray-900 dark:text-gray-100">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-[#CC322D] text-white py-3 px-4 rounded-lg font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors"
                >
                  Scan Next Ticket
                </button>
                <button
                  onClick={() => setScannedTicket(null)}
                  className="flex-1 bg-gray-600 dark:bg-gray-700 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-700 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
                >
                  Clear Results
                </button>
              </div>
          ...
          {/* Instructions */}
          {!scannedTicket && !isProcessing && (
            <div className="text-center py-8 bg-gray-50 dark:bg-[#18181b] rounded-lg">
