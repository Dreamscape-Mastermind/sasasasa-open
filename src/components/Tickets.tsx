...
import { TicketType, TicketTypeWithFlashSale } from "@/types";
...
export function Tickets({ tickets, formatDate }: TicketsProps) {
  ...
  const shouldShowRemainingTickets = (ticket: TicketWithFlashSale): boolean => {
  ...
  const isPopularTicket = (ticket: TicketWithFlashSale): boolean => {
  ...
  const getTicketDemandStatus = (
    ticket: TicketWithFlashSale
  ): string | null => {
    const totalSold = ticket.quantity - ticket.remaining_tickets;
                  ...
                  >
                    ...
                    {shouldShowRemainingTickets(ticket) && (
                      ...
                      >
                        ...
                        <span>
                          Only {ticket.flash_sale.remaining_tickets} left at
                          this price!
                        </span>
                      </motion.div>
                    )}
