...
export function FeaturedEvents({
  ...
  const handleViewAllClick = () => {
    try {
      ...
      logger.info("User clicked view all events", {
        source: "featured_events_section",
        eventCount: featuredEvents?.length || 0,
      });
    } catch (error) {
...
//   const handleClick = () => {
//     try {
//       analytics.trackUserAction("view_event", "event", event.title);
...
//     e.preventDefault();
//     try {
//       analytics.trackUserAction("play_event_preview", "event", event.title);
