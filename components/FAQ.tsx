...
const faqData = [
  {
    ...
    answer: "We accept various payment methods including Mobile Money (M-Pesa), credit cards, and (soon) select cryptocurrencies."
  },
  {
    question: "How quickly can event organizers access their funds?",
    answer: "Most payouts are processed within 24-48 hours, subject to our security verification process."
  },
  {
    question: "Can I sell tickets to virtual events?",
    answer: "Yes! Sasasasa supports both physical and virtual events, with integrated solutions for streaming and access management coming soon."
  },
  {
    question: "What makes Sasasasa different from other ticketing platforms?",
    answer: "We're built specifically for the Global South market, with features like offline ticket validation, multiple payment options, and fast local payouts."
  }
]; 